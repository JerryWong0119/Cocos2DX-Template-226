...
def checkParams(context):
    ...
    for i in range(1, len(sys.argv)):
        if "-project" == sys.argv[i]:
            ...
            context["dst_project_path"] = os.getcwd() + "/../../" + context["dst_project_name"]
    ...
    if ("cpp" == context["language"]):
        ...
        context["src_project_path"] = os.getcwd() + "/../../template/iOS-Cpp"
        platforms_list = ["iOS"]
#                          ,
#                          "android",
#                          "win32",
...
def processPlatformProjects(platform):
    # determine proj_path
    proj_path = context["dst_project_path"] + "/JWProject.%s/" % platform
    java_package_path = ""
    ...
    # done!
    print "JWProject.%s\t\t: Done!" % platform
